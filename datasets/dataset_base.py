...
from datasets.dataset_utils import slice_func, normalize_spec, get_dataset_stats, slice_func_waveform
...
from utils import *
from paths import path_cache_fs
import logging
...
class DatasetBase(Dataset):
    ...
    def get_labels_df(self):
        ...
        if self.normalize_labels: # normalizes annotations with 0 mean, 1 std
        ...
        if self.scale_labels: # scales annotations to lie between -1 and 1
